...
{
echo '<tr style="color:#2db44a"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This exam has been already solved by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$right*$total.'</td><td>'.$time.'&nbsp;min</td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/crane.png" width=100 height=100 alt="Crane.png" class="img-rounded">
		 </div>
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Kiran Neupane</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">(977)9865049674</h4>
		<h4 style="font-family:'typo' ">kirannpn@gmail.com</h4>
		<h4 style="font-family:'typo' ">Hetauda School of Management and Social Sciences, Hetauda-4</h4></div></div>
		</p>
      </div>
